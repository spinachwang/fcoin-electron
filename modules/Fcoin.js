...
const API = {
  ...
  curs: "https://api.fcoin.com/v2/public/currencies",
  symbols: "https://api.fcoin.com/v2/public/symbols"
}
// Util Func
...
class Fcoin {
  ...
  getCurs() {
    return fetch(API.curs).then(res => res.json());
  }

  getSymbols() {
    return fetch(API.symbols).then(res => res.json());
  }
